...
__author__ = 'Ajay Thampi, modified by Xiangwen Wang'
import os
import sys
import csv
...
# Schema of the GeoNames US Cities
GN_COLUMNS = {
    'geoNameId': 0,
    'name': 1,
    'asciiName': 2,
        ...
        if os.path.exists(local_filename):
            ...
            if not os.path.exists(cities_US_zipfilename):
                ...
                try: # Python 3
                    ...
                    urllib.request.urlretrieve(gn_cities_US_url, cities_US_zipfilename)
